...
const Reviews = () => {
  ...
  return (
    <div className="min-h-screen linear-to-br from-blue-50 to-blue-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {reviewsData?.data.reviews.map((review: Review) => (
            <div
              key={review.id}
              className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 p-6 border-l-4 border-blue-500"
            >
              {/* Review Header */}
